      ...
      <div className="pt-4 flex min-h-[60vh]">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <p className="mt-8 text-xl font-thin">
            A skilled <span className="font-bold">Next.js, React</span>{" "}
            developer with over 4 years of experience building robust, scalable,
        ...
        <div className="relative flex-1 grid place-items-center overflow-hidden ">
          <Image
            src={heropic}
            alt="hero picture"
            className="absolute h-[80%] w-full object-cover rounded-lg"
          />
        </div>
      </div>
    </Container>
